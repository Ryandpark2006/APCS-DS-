...
public class StringMethods_Demo
{
   public static void main(String[] args)
   {
      ...
      int result25 = s2.compareTo(s);			// some number > 0, because "n" > "I"
      ...
      For example, "09/12/2008" becomes "12-09-08".  
      */     
      String dateStr = "09/16/2008";
      dateStr = dateStr.substring(3,6)+dateStr.substring(0,3)+dateStr.substring(8);
      ...
      */      
      ...
      System.out.println( str );   // RT TJCheer2015 Freshman  Sophomores Interested in cheer at TJ Email thomasjeffersoncheergmailcom
      ...
      */      
      ...
      for(int i=0; i<str2.length(); i++ )
         if( letters.contains(""+str2.charAt(i)) )               
            cleaned += str2.charAt(i);
      System.out.println( cleaned );   //a galaxy far far away  right there on the TJ planetarium ceiling httpstcofoqby
   }
}
